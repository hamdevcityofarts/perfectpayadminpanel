    ...
    menuItems: [
      {
        icon: (
          <svg
          className="fill-current text-yellow-500" // Ajoute la classe text-yellow-500
          width="18"
          height="18"
          viewBox="0 0 18 18"
          fill="none"
        ...
        label: "Dashboard",
        route: "#",
        children: [{ label: "Transactions", route: "/" }],
      },
      {
        icon: (
          <svg
        ...
        >
          <path
            ...
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
          />
          <path
            d="M10 19C10 16.2386 12.2386 14 15 14H17C19.7614 14 22 16.2386 22 19V20H10V19Z"
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
          />
          <path
          ...
          />
          <path
            d="M2 19C2 16.2386 4.23858 14 7 14H8C8.66667 14 9.33333 14.1667 10 14.5C8.66667 15.8333 8 17.5 8 19V20H2V19Z"
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
          />
          <path
          ...
          />
          <path
            d="M12 19C12 16.2386 14.2386 14 17 14H18C18.6667 14 19.3333 14.1667 20 14.5C18.6667 15.8333 18 17.5 18 19V20H12V19Z"
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
          />
        </svg>
      ...
      },
      {
        icon: (
          ...
          viewBox="0 0 24 24"
          fill="none"
          className="text-yellow-500" // Ajoute la classe text-yellow-500
        >
          <rect
            x="2"
            y="3"
          ...
          <rect
            ...
            strokeWidth="0.5"
          />
          <circle cx="5" cy="12" r="0.75" fill="black" />
          <circle cx="5" cy="14" r="0.75" fill="black" />
          <circle cx="5" cy="16" r="0.75" fill="black" />
          <circle cx="19" cy="12" r="0.75" fill="black" />
          <circle cx="19" cy="14" r="0.75" fill="black" />
          <circle cx="19" cy="16" r="0.75" fill="black" />
          <rect
            x="8"
            y="17"
            width="8"
      ...
      },*/
      {
        icon: (
          ...
          className="text-yellow-500" // Ajoute la classe text-yellow-500
        >
          <circle cx="8" cy="8" r="3" stroke="currentColor" strokeWidth="1.5" fill="currentColor" />
          <path
            d="M5 14c0-1.5 1.5-3 3-3s3 1.5 3 3v1H5v-1z"
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
            stroke="currentColor" // Utilise currentColor pour appliquer la couleur
            strokeWidth="1.5"
          />
          <circle cx="16" cy="8" r="3" stroke="currentColor" strokeWidth="1.5" fill="currentColor" />
          <path
            d="M13 14c0-1.5 1.5-3 3-3s3 1.5 3 3v1h-6v-1z"
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
            stroke="currentColor" // Utilise currentColor pour appliquer la couleur
            strokeWidth="1.5"
          />
      ...
      },
      {
        icon: (
          ...
          className="text-yellow-500" // Ajoute la classe text-yellow-500
        >
          <circle cx="6" cy="8" r="3" stroke="currentColor" strokeWidth="1.5" fill="currentColor" />
          <path
            d="M3 14c0-1.5 1.5-3 3-3s3 1.5 3 3v1H3v-1z"
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
            stroke="currentColor" // Utilise currentColor pour appliquer la couleur
            strokeWidth="1.5"
          />
          
          <circle cx="18" cy="8" r="3" stroke="currentColor" strokeWidth="1.5" fill="currentColor" />
          <path
            d="M15 14c0-1.5 1.5-3 3-3s3 1.5 3 3v1h-6v-1z"
            fill="currentColor" // Utilise currentColor pour appliquer la couleur
            stroke="currentColor" // Utilise currentColor pour appliquer la couleur
            strokeWidth="1.5"
          />
          ...
          <line
            ...
            strokeWidth="1.5"
          />
          <circle cx="10.5" cy="18.5" r="0.5" fill="currentColor" /> // Utilise currentColor pour appliquer la couleur
        </svg>
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
            {menuGroups.map((group, groupIndex) => (
              <div key={groupIndex}>
                <h3 className="mb-4 ml-4 text-sm font-semibold text-red-700">
  {group.name}
</h3>
